...
sub inspect {
    ...
    my @methods = qw/string decoded normalized scheme authority host ip ipv4 ipv6 ipvx zone port path segments query fragment drive user password is_abs to headers is_localpath/;
