...
sub inspect {
    ...
    my @methods = qw/string scheme authority host ip ipv4 ipv6 ipvx zone port path segments query fragment drive user password/;
    my @_methods = qw/_string _scheme _authority _host _ip _ipv4 _ipv6 _ipvx _zone _port _path _segments _query _fragment _drive _user _password/;
